                        ...
                        {[1, 2, 3, 4, 5].map(i => (
                          <div 
                            ...
                            style={{
                              ...
                              backgroundColor: i <= passwordStrength.strength ? passwordStrength.color : '#30363D'
                            }}
                          />
                        ))}
                      </div>
        ...
        <div style={styles.brandContent}>
          ...
          <div style={styles.features}>
            <div style={styles.feature}>
              <div style={{ ...styles.featureCheck, backgroundColor: password.length >= 8 ? 'rgba(34, 197, 94, 0.1)' : 'rgba(107, 114, 128, 0.1)', color: password.length >= 8 ? '#22C55E' : '#6B7280' }}>
                {password.length >= 8 ? '✓' : '○'}
              </div>
              <span>At least 8 characters</span>
            </div>
            <div style={styles.feature}>
              <div style={{ ...styles.featureCheck, backgroundColor: /[A-Z]/.test(password) ? 'rgba(34, 197, 94, 0.1)' : 'rgba(107, 114, 128, 0.1)', color: /[A-Z]/.test(password) ? '#22C55E' : '#6B7280' }}>
                {/[A-Z]/.test(password) ? '✓' : '○'}
              </div>
            ...
            <div style={styles.feature}>
              <div style={{ ...styles.featureCheck, backgroundColor: /[0-9]/.test(password) ? 'rgba(34, 197, 94, 0.1)' : 'rgba(107, 114, 128, 0.1)', color: /[0-9]/.test(password) ? '#22C55E' : '#6B7280' }}>
                {/[0-9]/.test(password) ? '✓' : '○'}
              </div>
              <span>One number</span>
            </div>
            <div style={styles.feature}>
              <div style={{ ...styles.featureCheck, backgroundColor: /[^A-Za-z0-9]/.test(password) ? 'rgba(34, 197, 94, 0.1)' : 'rgba(107, 114, 128, 0.1)', color: /[^A-Za-z0-9]/.test(password) ? '#22C55E' : '#6B7280' }}>
